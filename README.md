...
>**`Experimental`** (taking into consideration the suggestions): [v6.4.7](https://github.com/ancandi/YouTube-Mobile-URL-Shield-AB/raw/refs/heads/main/url-shield-ab+-test.user.js)
